...
--Command     : generate_target color_design_wrapper.bd
--Design      : color_design_wrapper
...
entity color_design_wrapper is
  port (
...
end color_design_wrapper;

architecture STRUCTURE of color_design_wrapper is
  component color_design is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
...
color_design_i: component color_design
     port map (
